...
class MelisFieldRow extends FormRow
{
	...
	public function render(ElementInterface $element, ?string $labelPosition = null): string
	{
	    ...
	    if(!empty($element->getOption('tooltip')))
	    {
	        ...
	        $label = $element->getLabel().'<i class="fa fa-info-circle fa-lg pull-right" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="'.$element->getOption('tooltip').'"></i>';
